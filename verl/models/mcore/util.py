...
from verl.utils.device import is_npu_available  # needed by preprocess_for_mindspeed (predictor port)
...
# ============================================================================
# Functions ported from feat/predictor-stream-overlap for predictor compat.
# (v0.7.1 has the *_no_padding variants; these *_engine + npu helpers are net-new.)
# ============================================================================
