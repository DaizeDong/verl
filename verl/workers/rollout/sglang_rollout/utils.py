...
# Default LoRA name used when actor pushes adapter weights into the sglang engine.
# Sourced from feat/predictor-stream-overlap where it was added alongside the
# bias_predictor lora injection.
